<x-portal.layout title="Show Room">
                        ...
                        <div class="room-booking-form">
                            ...
                            <form action="">
                                <div class="review-input">
                                    <div class="review-input-box">  
                                        ...
                                        <input type="text" name="check_in" placeholder="{{ \App\Helpers\SearchHelper::getPreviousSearchRequest()['check_in'] ?? 'Check In' }}" 
                                        value="{{ \App\Helpers\SearchHelper::getPreviousSearchRequest()['check_in'] ?? '' }}"
                                        class="date-picker hasDatepicker" id="dp1720541142932">
                                    </div>
                                    <div class="review-input-box">
                                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <mask id="mask0_281_1609" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="25">
                                        ...
                                        <input type="text" name="check_out" placeholder="{{ \App\Helpers\SearchHelper::getPreviousSearchRequest()['check_in'] ?? 'Check out' }}" 
                                        value="{{ \App\Helpers\SearchHelper::getPreviousSearchRequest()['check_in'] ?? '' }}"
                                        class="date-picker hasDatepicker" id="dp1720541142933">
                                    </div>
                                </div>
                                <div class="review-input">
                            <div class="review-input-box">
                            ...
                            <div class="review-input-box">
                               ...
                               <img src="assets/img/home/arrow_drop_down.png" alt="">
                                ...
                                <a href="#check_rooms" class="btn-bg d-block w-100 text-center">Check Available Rooms</a>
    ...
    <section class="single-room-column-area" id="check_rooms">
        <div class="container">
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="room-column-slider">
                            ...
                            <div id="room-indicator-1" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <img src="{{$room->primary_image_url}}" class="d-block w-100" alt="...">
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8">
                            <div class="property-content">
                                <h5><img src="assets/img/icon-star.png" alt=""> {{$property->property_class}} Hotel</h5>
