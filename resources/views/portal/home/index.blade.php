               ...
               <form action="{{ route('portal.property.search') }}"  method="GET" class="review-box-home">
                  ...
                  <div class="review-input">
                     <div class="review-input-box">
                        ...
                        <input type="text" name="check_in" placeholder="Check In" class="date-picker"  name="check_in">
                     </div>
                     <div class="review-input-box">
                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <mask id="mask0_281_1609" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="25">
                        ...
                        <input type="text"  name="check_out" placeholder="Check Out" class="date-picker">
                     </div>
                  </div>
                  <div class="review-input">
                     <div class="review-input-box">
