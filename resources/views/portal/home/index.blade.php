               ...
               <form action="{{ route('portal.property.search') }}"  method="GET" class="review-box-home">
                  ...
                  <div class="review-input">
                     <div class="review-input-box full-box">
                        ...
                        <input type="text" name="location" placeholder="{{ $errors->has('location') ? '*Please fill the location' : 'Cox\'s Bazar. Chittagong' }}" value="{{old('location') }}" >
                     </div>
                  </div>
                  <div class="review-input">
                     <div class="review-input-box">
                        ...
                        <input type="text" name="check_in" placeholder="Check In" class="date-picker"  value="" id="check-in-date">
                     </div>
                     <div class="review-input-box">
                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <mask id="mask0_281_1609" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="25">
                        ...
                        <input type="text"  name="check_out" placeholder="Check Out" class="date-picker" value="" id="check-out-date">
                     </div>
                  </div>
                  <div class="review-input">
                     <div class="review-input-box">
                        ...
                        <input type="number" name="number_adults"  min="0" max="100" placeholder="2 Adult">
                        ...
                        <button type="button" onclick="this.parentNode.querySelector('[type=number]').stepUp();">
                           <img src="{{asset('assets/portal/img/home/arrow_drop_down.png')}}" alt="">
                        </button>
                     </div>
                     <div class="review-input-box">
                        <input type="number" name="number_children" min="0" max="100" placeholder="0 Child">
                        <button type="button" onclick="this.parentNode.querySelector('[type=number]').stepDown();">
                           <img src="{{asset('assets/portal/img/home/arrow_drop_up.png')}}" alt="">
                        </button>
                        <button type="button" onclick="this.parentNode.querySelector('[type=number]').stepUp();">
                     ...
                     <div class="review-input-box">
                        <input type="number" name="number_rooms" min="0" max="100" placeholder="1 Room">
                        <button type="button" onclick="this.parentNode.querySelector('[type=number]').stepDown();">
                           <img src="{{asset('assets/portal/img/home/arrow_drop_up.png')}}" alt="">
                        </button>
                        <button type="button" onclick="this.parentNode.querySelector('[type=number]').stepUp();">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="bannar-content">
                              ...
                              <a href="{{ route('portal.place.property.show', ['place' => $place->id, 'slug' => \Illuminate\Support\Str::slug($place->name)]) }}" class="btn-border">Explore Hotels</a>
                           </div>
                        </div>
                        <div class="col-md-5">
         ...
         <div class="row">
            <div class="col-md-5">
               <div class="promo-content">
                  ...
                  <div class="promo-img">
                     <img src="{{asset('assets/portal/img/home/home-qr-code.svg')}}" alt="">
            ...
            <div class="col-md-7">
               <img src="{{asset('assets/portal/img/home/home-promo.png')}}" alt="">
            </div>
         </div>
      </div>
   </section>
            ...
            <div class="col-md-10 mx-auto">
               <div class="row align-items-center">
                  <div class="col-md-7">
                     <div class="single-feature d-flex align-items-center">
                      <span>
                      <img src="{{asset('assets/portal/img/icons/feature-number-1.png')}}" alt="">
                      </span>
                  ...
                  <div class="col-md-5">
                     <img src="{{asset('assets/portal/img//icons/feature-icon-1.png')}}" alt="" class="single-feature-img">
                  </div>
               </div>
               <div class="row align-items-center">
                  <div class="col-md-5">
                     <img src="{{asset('assets/portal/img//icons/feature-icon-2.png')}}" alt="" class="single-feature-img">
                  </div>
                  <div class="col-md-7">
                     <div class="single-feature d-flex align-items-center">
                      <span>
                      <img src="{{asset('assets/portal/img/icons/feature-number-2.png')}}" alt="">
                      </span>
                        <div class="single-feature-content">
               ...
               <div class="row align-items-center">
                  <div class="col-md-7">
                     <div class="single-feature d-flex align-items-center">
                      <span>
                      <img src="{{asset('assets/portal/img/icons/feature-number-3.png')}}" alt="">
                      </span>
                        <div class="single-feature-content">
                  ...
                  <div class="col-md-5">
                     <img src="{{asset('assets/portal/img//icons/feature-icon-3.png')}}" alt="" class="single-feature-img">
                  </div>
               </div>
               <div class="row align-items-center">
                  <div class="col-md-5">
                     <img src="{{asset('assets/portal/img//icons/feature-icon-4.png')}}" alt="" class="single-feature-img">
                  </div>
                  <div class="col-md-7">
                     <div class="single-feature d-flex align-items-center">
                      <span>
                      <img src="{{asset('assets/portal/img/icons/feature-number-4.png')}}" alt="">
                      </span>
                        <div class="single-feature-content">
         ...
         <div class="col-md-10 mx-auto text-center">
            ...
            <form action="">
               <div class="subscribe-group">
                  <img class="icon-envelope" src="{{asset('assets/portal/img/icons/envelope.png')}}" alt="">
                  <input type="email" name="" id="" placeholder="enter your email here">
                  <img class="icon-close" src="{{asset('assets/portal/img/icons/close.png')}}" alt="">
               </div>
