                   ...
                   <span>
                      ...
                      All Filter
                        ...
                        <div class="filter-button position-relative">
                            ...
                            Facilities  <span><img src="{{asset('assets/portal/img/icons/icon-caret.svg')}}" alt=""></span>
                            <div class="filter-dropdown">
                                <div class="filter-dropdown-box">
                                    <h4 class="d-flex justify-content-between">Facilities <span>Clear <img src="{{asset('assets/portal/img/icons/icon-cancel.png')}}" alt=""></span></h4>
                        ...
                        <div class="filter-button position-relative">
                            ...
                            Meal  <span><img src="{{asset('assets/portal/img/icons/icon-caret.svg')}}" alt=""></span>
                            <div class="filter-dropdown">
                                <div class="filter-dropdown-box">
                                    <h4 class="d-flex justify-content-between">Meals <span>Clear <img src="{{asset('assets/portal/img/icons/icon-cancel.png')}}" alt=""></span></h4>
                                    <div class="filter-dropdown-items d-flex justify-content-between flex-wrap">
                                        <div class="single-filter-dropdown">
                        ...
                        <div class="filter-button position-relative">
                            ...
                            Hotel Classes  <span><img src="{{asset('assets/portal/img/icons/icon-caret.svg')}}" alt=""></span>
                            <div class="filter-dropdown">
                                <div class="filter-dropdown-box">
                                    <h4 class="d-flex justify-content-between">Hotel Class <span>Clear <img src="{{asset('assets/portal/img/icons/icon-cancel.png')}}" alt=""></span></h4>
                                    <div class="filter-dropdown-items d-flex justify-content-between flex-wrap">
                                        <div class="single-filter-dropdown">
                        ...
                        <div class="filter-button position-relative">
                            ...
                            Ratings <span><img src="{{asset('assets/portal/img/icons/icon-caret.svg')}}" alt=""></span>
                            <div class="filter-dropdown">
                                <div class="filter-dropdown-box">
                                    <h4 class="d-flex justify-content-between">Ratings <span>Clear <img src="{{asset('assets/portal/img/icons/icon-cancel.png')}}" alt=""></span></h4>
                                    <div class="filter-dropdown-items d-flex justify-content-between flex-wrap">
                                        <div class="single-filter-dropdown">
                        ...
                        <div class="filter-button position-relative">
                            ...
                            Property Type  <span><img src="{{asset('assets/portal/img/icons/icon-caret.svg')}}" alt=""></span>
                            <div class="filter-dropdown">
                                <div class="filter-dropdown-box">
                                    <h4 class="d-flex justify-content-between">Property Type <span>Clear <img src="{{asset('assets/portal/img/icons/icon-cancel.png')}}" alt=""></span></h4>
                        ...
                        <div class="filter-button position-relative">
                            ...
                            Sort By  <span><img src="{{asset('assets/portal/img/icons/icon-caret.svg')}}" alt=""></span>
                            <div class="filter-dropdown dropdown-radio">
                                <div class="filter-dropdown-box">
                                    <h4 class="d-flex justify-content-between">Short By <span>Clear <img src="{{asset('assets/portal/img/icons/icon-cancel.png')}}" alt=""></span></h4>
