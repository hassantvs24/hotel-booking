...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('rooms', function (Blueprint $table) {
            ...
            $table->foreignId('bed_type_id')->nullable()->constrained()->onDelete('Set Null')->onUpdate('No Action');
            $table->foreignId('room_type_id')->nullable()->constrained()->onDelete('Set Null')->onUpdate('No Action');
